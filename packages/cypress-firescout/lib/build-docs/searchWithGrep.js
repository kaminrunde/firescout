...
function searchWithGrep() {
    ...
    var DOCS_CMD = "grep -rl \"<!-- firescout-(component|collection) -->\" " + config.widgetFolders;
    var HANDLES_CMD = "grep -HREo \"data-cy-(state|ctx|handle|collection)=(\\\"|').*(\\\"|')\" " + config.widgetFolders;
    return Promise.all([
