...
var parseSystemInput_1 = __importDefault(require("./parseSystemInput"));
...
var doParsing = config_1.default.useGrep
    ? function () { return Promise.all([
        utils.executeCmd(DOCS_CMD),
        utils.executeCmd(HANDLES_CMD)
    ]).then(parseSystemInput_1.default); }
    : function () { return findInFiles_1.default(); };
doParsing()
