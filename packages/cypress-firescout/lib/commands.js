    ...
    if (Cypress.env("firescoutTsFixtures")) {
        ...
        if (variation) {
            cy.fixture(path).then(function (file) {
                ...
                var fn = new Function("return " + match[1]);
                var json = fn();
                var hasOptions = typeof json === "object" &&
                    json &&
                    Boolean(json.__firescoutOptions);
                ...
                get = rootOpt.timeout
                    ? function () {
                        return new Promise(function (resolve) {
                            return setTimeout(function () { return resolve(json); }, rootOpt.timeout);
                        });
                    }
        ...
        if (variation) {
            cy.fixture(path).then(function (file) {
                var hasOptions = typeof file === "object" &&
                    file &&
                    Boolean(file.__firescoutOptions);
                ...
                get = rootOpt.timeout
                    ? function () {
                        return new Promise(function (resolve) {
                            return setTimeout(function () { return resolve(result); }, rootOpt.timeout);
                        });
                    }
...
Cypress.Commands.add("doesReturn", { prevSubject: true }, function (_a, data, opt) {
    ...
    var get = opt.timeout
        ? function () {
            return new Promise(function (resolve) { return setTimeout(function () { return resolve(data); }, opt.timeout); });
        }
