...
describe('(feature) grouped handles/states', function () {
    it.only('can add create a grouped state', function () { return __awaiter(void 0, void 0, void 0, function () {
        var t, result, c1, visibleState;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    c1 = result.getComponent('C1');
                    expect(c1.states).toHaveLength(1);
                    visibleState = c1.states[0];
