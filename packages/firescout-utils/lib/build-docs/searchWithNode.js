    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            findAllFiles(__spreadArrays(config.widgetFolders, [config.fixturesFolder])),
          ]
        case 1:
          files = _a.sent()
            ...
            Promise.all(
              __spreadArrays(
                srcFiles.map(function (f) {
                  return getSrcMatch(f.path)
                }),
                fixtureFiles.map(function (f) {
                  return getFixtureMatch(f.path)
                })
              )
            ),
          ]
...
function getSrcMatch(path) {
  return __awaiter(this, void 0, void 0, function () {
    var result,
      ...
      moduleCommentRegex,
      variableRegex,
      variableCommentRegex,
      cMatchesString,
      cMatchesCond,
      moduleMatches,
      moduleCommentMatches,
      variableMatches,
      variableCommentMatches,
      regex_1,
      matches,
      sMatchesRegex,
      _i,
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          if (path.endsWith('.md')) {
            ...
            else return [2 /*return*/, null]
          }
          allMatches = []
          cRegexString = new RegExp(
            'data-cy-(state|ctx|handle|collection)[^="\' ]* ?=("|\')[^("|\')]*.',
            'g'
          )
          cRegexCond = new RegExp(
            'data-cy-(state|ctx|handle|collection)[^="\' ]*= ?[^"\'][^}]*}',
            'g'
          )
          ...
          if (cMatchesString) {
            ...
            matches = cMatchesString.map(function (s) {
              return s.match(regex_1)
            })
            allMatches.push.apply(
              allMatches,
          ...
          if (cMatchesCond) {
            ...
            matches = cMatchesCond
              .map(function (s) {
                return s.match(regex_2)
              })
              .filter(function (a) {
                return a && a[0]
              })
          ...
          if (moduleMatches) {
            ...
            matches = moduleMatches.map(function (s) {
              return s.match(regex_3)
            })
            allMatches.push.apply(
              allMatches,
              matches.map(function (match) {
          ...
          if (moduleCommentMatches) {
            ...
            matches = moduleCommentMatches.map(function (s) {
              return s.match(regex_4)
            })
            allMatches.push.apply(
              allMatches,
              matches.map(function (match) {
          ...
          if (variableCommentMatches) {
            ...
            matches = variableCommentMatches.map(function (s) {
              return s.match(regex_5)
            })
            allMatches.push.apply(
              allMatches,
              matches.map(function (match) {
          ...
          if (variableMatches) {
            ...
            matches = variableMatches.map(function (s) {
              return s.match(regex_6)
            })
            allMatches.push.apply(
              allMatches,
              matches.map(function (match) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          config = config_1.default()
          if (!path.endsWith('.ts')) return [2 /*return*/, null]
          return [4 /*yield*/, utils.readFile(path)]
        case 1:
          content = _c.sent()
          result = '/**\n * ...\n */'
          ...
          if (relPath.split('/').length !== 2) return [2 /*return*/, null]
